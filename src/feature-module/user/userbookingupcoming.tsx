          ...
          <div className="row d-flex align-items-center">
            <div className="col-xl-7 col-lg-8 col-sm-12 col-12">
              ...
              <ul className="nav">
                  ...
                  <li><Link to={routes.bookingcancelled}>Cancelled</Link></li>
                </ul>
              </div>
            </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-7 text-md-end">
                ...
                <input type="text" placeholder="Search" id="tablefilter" className="inputsearch"/>
                  <Link to={routes.listinggrid} className="btn btn-add"><i className="feather-plus-circle" />Add Booking</Link>	
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="modal-body">
          <div className="booking-header">
            ...
            <div className="book-amount">
              <p>Total Amount</p>
              <h6>$4700 <Link to="#"><i className="feather-alert-circle" /></Link></h6>
            </div>
          </div>
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          ...
          <div className="booking-group">
            ...
            <div className="booking-wrapper">
              <div className="booking-title">
                <h6><span className="title-icon"><i className="fa-solid fa-location-dot" /></span>Select Booking type &amp; Time <Link to="#"><i className="feather-alert-circle" /></Link></h6>
              </div>							
              <div className="row">
