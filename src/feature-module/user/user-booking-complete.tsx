  ...
  const action = () => {
    return (
      <div className="dropdown dropdown-action">
        <a to="#" className="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          <i className="fas fa-ellipsis-vertical" />
        </a>
        <div className="dropdown-menu dropdown-menu-end">
          <a className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#complete_booking">
            <i className="feather-eye" /> View
          </a>
          <a className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#delete_modal">
              ...
              <div className="modal-body">
                <div className="booking-header">
                  ...
                  <div className="book-amount">
                    <p>Total Amount</p>
                    <h6>$4700 <a to="#"><i className="feather-alert-circle" /></a></h6>
                  </div>
                </div>
                ...
                <div className="modal-btn modal-btn-sm text-end">
                  <a to="#" data-bs-target="#start_ride" data-bs-toggle="modal" data-bs-dismiss="modal" className="btn btn-primary">
                    Start Ride
                  </a>
                </div>
              </div>
              ...
              <div className="modal-body">
                <div className="order-success-info">
                  ...
                  <div className="modal-btn">
                    <a to="user-dashboard.html" className="btn btn-secondary">
              ...
              <div className="modal-body">
                <div className="delete-action">
                  ...
                  <div className="modal-btn">
                    <div className="row">
                      <div className="col-6">
                        <a to="#" data-bs-dismiss="modal" className="btn btn-secondary w-100">
                          Delete
                        </a>
                      </div>
                      <div className="col-6">
                        <a to="#" data-bs-dismiss="modal" className="btn btn-primary w-100">
                          Cancel
                        </a>
                      </div>
                    </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form action="#">
                  ...
                  <div className="modal-btn modal-btn-sm text-end">
                    <a to="#" data-bs-dismiss="modal" className="btn btn-secondary">
                      Cancel Booking
                    </a>
                    <a to="#" data-bs-dismiss="modal" className="btn btn-primary">
                      Start Ride
                    </a>
                  </div>
                </form>
